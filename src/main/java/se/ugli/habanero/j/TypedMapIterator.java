...
public abstract class TypedMapIterator<T> extends ResultSetIterator<T> {
    ...
    private static Iterable<String> createColumns(final ResultSet resultSet) throws SQLException {
    ...
    private static Object expandColumnValue(final Object columnValue) {
